...
class SimpleRobotSim( RobotSimInterface ):
    def __init__(self, *args, **kw):
        ...
        # FIXME
        self.dNoise = 0.15 # Distance noise 0.1
        self.aNoise = 0.03 # Angle noise 0.02
        self.lNoise = 0.02 # Laser pointing noise 0.01
    ...
    def basewheels(self,dist,wheel):
        ...
        return [c_[self.pos.real,self.pos.imag], self.getangle(self.ang)]
